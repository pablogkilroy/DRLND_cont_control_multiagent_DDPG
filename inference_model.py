...
# tennis = Actor(state_size, action_size, seed = 5).to(device)

agent.actor_local.load_state_dict(torch.load(r'checkpoint_actor.pth'))
agent.actor_local.eval()


def play(n_episodes=10000, max_t=1000, print_every=100, plot_every=250):
